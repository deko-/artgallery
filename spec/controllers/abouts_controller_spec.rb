...
describe AboutsController do
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested about" do
        ...
        put :update, :id => about.id, :about => {'these' => 'params'}
      end

      it "assigns the requested about as @about" do
        about = About.create! valid_attributes
        put :update, :id => about.id, :about => valid_attributes
        assigns(:about).should eq(about)
      end
    ...
    describe "with invalid params" do
      it "assigns the about as @about" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        About.any_instance.stub(:save).and_return(false)
        put :update, :id => about.id.to_s, :about => {}
        assigns(:about).should eq(about)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested about" do
      about = About.create! valid_attributes
      expect {
        delete :destroy, :id => about.id.to_s
      }.to change(About, :count).by(-1)
    end
